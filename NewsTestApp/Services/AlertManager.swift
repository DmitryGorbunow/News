...
extension AlertManager {
    ...
    public static func showInvalidEmailAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Ошибка", message: "Проверьте корректность ввода почты")
    }
    
    public static func showInvalidPasswordAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Ошибка", message: "Проверьте корректность ввода пароля. Пароль должен содержать заглавные буквы, числа и специальные символы")
    }
    
    public static func showInvalidUsernameAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Ошибка", message: "Проверьте корректность ввода имени")
    }
}
...
extension AlertManager {
    ...
    public static func showPasswordResetSent(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Успешно", message: "Инструкция по сбросу пароля придет вам на почту")
    }
